...
Generate a verifiable, archivable reproduction capsule:

```bash
# Generate capsule during reproduction
...
A capsule contains: manifest, reports, logs, artifacts, metadata, and
SHA256 integrity checksums. It is a self-contained evidence package for
a reproduction attempt.

**Important:** A capsule is NOT proof that a paper is correct. It records
what was done, not whether the results are valid.

See [docs/reproduction-capsules.md](docs/reproduction-capsules.md),
[docs/capsule-format.md](docs/capsule-format.md),
[docs/capsule-verify.md](docs/capsule-verify.md),
[docs/capsule-security.md](docs/capsule-security.md).
